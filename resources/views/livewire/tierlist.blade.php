<div class="columns-two__5-1 text-white d-grid">
        ...
        <form action="/ships/filter" method="GET" autocomplete="off">
            ...
            <div class="columns-two__1-5 d-grid">
                ...
                <div class="d-grid mb-2">
                    ...
                    <div wire:model="byHull" class="wrapper bg-gray1 p-1 rounded">
                        ...
                        <select name="hull"  id="hull"
                            ...
                            @foreach ($hulls as $key => $h)
                                @if ($key == 0)
                                    @continue;
                                @endif
                                <option {{$byHull == $h->id ? 'selected': ''}} class="mx-auto mt-auto mb-2 altona-sans-12"
                        ...
                        <script>
                            $(document).ready(function() {
                                let hullID = document.getElementById("hull").options;
                ...
                <div class="d-grid gap-3">
                    ...
                    <div class="columns-two__4-2 gap-2 d-grid">
                                ...
                                <div>
                                    <ul class="filter-list bg-gray1 rounded d-flex fit-content">
                                        @foreach ($rarity as $key => $r)
                                            <li>
                                                <input wire:model="byRarities" class="filter-option" type="checkbox" name="rarity[]"
                                                    id="{{ $r->rarity_name }}" value="{{ $r->rarity_slug }}"
                                                    {{ in_array($r->rarity_slug, $byRarities) ? ' checked' : '' }}>
                                ...
                                <div>
                                    <ul class="filter-list bg-gray1 rounded d-flex flex-wrap fit-content">
                                        @foreach ($factions as $key => $r)
                                            ...
                                            @endif
                                            <li>
                                                <input wire:model="byFactions" class="filter-option" type="checkbox" name="faction[]"
                                                    id="{{ $r->faction_tag }}" value="{{ $r->faction_slug }}"
                                                    {{ in_array($r->faction_slug, $byFactions) ? ' checked' : '' }}>
                        ...
                        <div class="d-grid">
                            ...
                            <select wire:model="byPosition" name="position" id="position"
                                class="pill-dark altona-sans-12 text-center button-square">
                                <option value="">None</option>

                                <option value="tank" {{ $byPosition == 'tank' ? 'selected' : '' }}>Tank
                                </option>
                                <option value="offtank" {{ $byPosition == 'offtank' ? 'selected' : '' }}>
                                    Offtank
                                </option>
                                <option value="mid" {{ $byPosition == 'mid' ? 'selected' : '' }}>Mid
                                </option>
                                <option value="flagship" {{ $byPosition == 'flagship' ? 'selected' : '' }}>
                                    Flagship
                                </option>
                                <option value="offflag {{ $byPosition == 'offflag' ? 'selected' : '' }}">
                                    Off Flag</option>
                                <option value="any" {{ $byPosition == 'any' ? 'selected' : '' }}>Any
                                </option>
                            </select>
    ...
    <div class="scores my-auto p-2" id="scores">
        ...
        <div class="d-flex text-white gap-2 justify-content-center mt-3">
            ...
            <button data-toggle="tab" class="nav-link btn btn-dark score-link altona-sans-12 p-1"
                onclick="openTab(event, 'score-14', 'score-content', 'score-link','grid')" id="score3-link">W
                14</button>
...
<div class="tierlist text-white my-5">
    ...
    <script>
        $(document).ready(function() {
            var opened = document.getElementById(localStorage.getItem('activeTab')) ? document.getElementById(
                localStorage.getItem('activeTab')) : document.getElementById('mob-link');
            opened.click();
        });
        $(document).ready(function() {
