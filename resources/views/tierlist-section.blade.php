                ...
                <div class="tierlist text-white">
                    ...
                    <div class="ship-row columns-eight mb-3">
                        <div class="d-flex grid-col-span-4">
                            <div class="sr-tag">
                                <p class="rotate--90">SR</p>
                            </div>
                            <img src="/resource/image/Ulrich_von_HuttenChibi.png" alt="" class="chibi-img">
                            <span class="swiss-font-18 my-auto">Ulrich von Hutten</span>
                        </div>
                        <div class="border-left-white d-grid">
                            <div class="m-auto altona-sans-10">Timed Barrager</div>
                        </div>
                        <div class="border-left-white d-grid">
                            <div class="m-auto altona-sans-10">Timed Barrager</div>
                            <div class="mx-auto">
                                <img class="position-row-img" src="/resource/image/Flagship.png" alt="position">
                            </div>
                        </div>
                        <div class="border-left-white grid-col-span-2">
                            ...
                            <div class="d-flex h-100 justify-content-around align-items-center">
                                <div class="score-box score-9">
                                    <div class="score swiss-font-18">11</div>
                                </div>
                                <div class="score-box score-9">
                                    <div class="score swiss-font-18">11</div>
                                </div>
